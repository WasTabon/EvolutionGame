...
public class SetupGameScene_Iteration7
{
    [MenuItem("EvolutionGame/Setup Game Scene (Iteration 7)")]
    static void Setup()
    {
        EnsureAudioManager();

        EditorApplication.ExecuteMenuItem("File/Save");
        Debug.Log("[Iteration 7] Audio setup complete on Game scene!");
    }
    ...
    static void EnsureAudioManager()
    {
        ...
        if (config == null)
        {
            ...
            Debug.Log("[Iteration 7] AudioConfig.asset created. Assign AudioClips in the Inspector.");
        }
